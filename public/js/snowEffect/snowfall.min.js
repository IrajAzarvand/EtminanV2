...
var snowFall = function() {
    function e() {
        var e = { flakeCount: 50, flakeColor: "#ffffff", flakeIndex: 999999, flakePosition: "absolute", minSize: 2, maxSize: 3, minSpeed: 1, maxSpeed: 5, round: 1, shadow: !1, collection: !1, image: !1, collectionHeight: 40 },
            t = [],
            n = {},
            o = 0,
            s = 0,
            ...
            h = function(e, t) { e.style.webkitTransform = t, e.style.MozTransform = t, e.style.msTransform = t, e.style.OTransform = t, e.style.transform = t },
            m = function(e, t) { return Math.round(e + Math.random() * (t - e)) },
            f = function(e, t) { for (var i in t) e.style[i] = t[i] + ("width" == i || "height" == i ? "px" : "") },
            d = function(t, i, n) {
